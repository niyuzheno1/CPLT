...
module.exports = grammar({
  ...
  rules: {
    ...
    read_declarator: $ => prec.dynamic(1, prec.right(seq(
      $.at_symbol,
      field('declarator', $._declarator)
    ))),
    ...
    break_statement: $ => seq(
      choice('break', /[break_]+break/) , ';'
    ),

    continue_statement: $ => seq(
      choice('continue', /[break_]+continue/), ';'
    ),
  ...
  binary_search_expression: $ => seq(
    ...
    range_result_statement: $ => prec.left(20, seq(
      choice(
        "min",
        "max",
        "sum",
      ...
      "[",
        choice($.subrange_expression,$.subsub_range_expression), 
      "]",
      "(",
      $._expression,
      ")"
    ...
    subrange_expression : $ =>  prec.left(PREC.READ,  seq(
        field('left', $.subsub_range_expression),
        ',',
        field('right', choice($.subrange_expression, $.subsub_range_expression))
    )),
    
    subsub_range_expression : $ => choice( 
      seq(
        $._expression,
        "=",
        $._expression,
    ...
    read_expression: $ => prec.left(PREC.READ, seq(
      optional(field('left', $._expression)),
      field('operator', $.at_symbol),
      choice(
    ...
    comma_expression: $ =>  prec.left(PREC.READ,  seq(
